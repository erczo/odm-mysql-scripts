...
-- ----------------------------
--  Table structure for `datavalues_month`
-- ----------------------------
DROP TABLE IF EXISTS `datavalues_month`;
CREATE TABLE `datavalues_month` (
...
CREATE UNIQUE INDEX `uk_datavalues_month_1` ON `datavalues_month` (`DatastreamID`, `LocalDateTime`) USING BTREE;
CREATE UNIQUE INDEX `uk_datavalues_month_2` ON `datavalues_month` (`LocalDateTime`, `DatastreamID`) USING BTREE;
