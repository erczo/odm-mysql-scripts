...
-- ----------------------------
--  Table structure for `datavalues_seasonal`
-- ----------------------------
DROP TABLE IF EXISTS `datavalues_seasonal`;
...
CREATE UNIQUE INDEX `uk_datavalues_seasonal_1` ON `datavalues_seasonal` (`DatastreamID`, `LocalDateTime`) USING BTREE;
CREATE UNIQUE INDEX `uk_datavalues_seasonal_2` ON `datavalues_seasonal` (`LocalDateTime`, `DatastreamID`) USING BTREE;
