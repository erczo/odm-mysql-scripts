/**
 * Populates the datavalues_day table with daily MIN/MAX/AVG (mma) aggregates derived from datavalues2.
 *
 * NOTES:
 ...
 */
DROP PROCEDURE IF EXISTS `usp_load_datavalues_day_mma_dv2`;

DELIMITER //
CREATE PROCEDURE `usp_load_datavalues_day_mma_dv2`
